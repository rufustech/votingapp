  ...
  return (
    <div className="container mx-auto max-w-4xl mt-16 px-6 py-20">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold dark:text-gray-200 text-[#9c27b0] mb-4">Contact Us</h1>
      ...
      >
        ...
        <button
          type="submit"
          className="bg-[#9c27b0] hover:bg-blue-700 text-white px-6 py-3 rounded text-lg font-medium w-full"
        >
          Send Message
        </button>
      </form>
